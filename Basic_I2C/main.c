...
int I2C_ReadByte(char *data)
{
	...
	I2C1->DR = 0x30; //put the slave address into the data register, transmitting
	...
	I2C1->DR = 0x1E; //put one of the slaves internal register address into the data register
	...
	I2C1->DR = 0x31; //put the slave address into the data register, recieving
